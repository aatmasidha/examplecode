...
@Entity
@Table(name = "event_category_configuration", uniqueConstraints = @UniqueConstraint(columnNames = { "name" }))
public class EventCategoryConfiguration {
	...
	public EventCategoryConfiguration(String name) {
		super();
		this.name = name;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof RoomTypeMaster))
			return false;
		EventCategoryConfiguration other = (EventCategoryConfiguration) obj;
		if (id != other.id)
			return false;
		if (name == null) {
			if (other.name != null)
